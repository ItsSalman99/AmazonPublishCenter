...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap shadow p-2">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Amazon Publish Center</a>
        ...
        <div class="navbar-nav">
            <div class="nav-item text-nowrap">
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button class="btn btn-sm btn-danger p-2" type="submit">
                        Sign out
                    </button>
                </form>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="747" height="315"
                    style="display: block; height: 252px; width: 598px;"></canvas>
