                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h5>All Trashed (Deleted) Clients</h5>
                            </div>
                                ...
                                @forelse ($clients as $client)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <a href="{{ route('clients.restore', ['id'=>$client->id]) }}" class="btn btn-sm btn-success">
                                                        <i class="bi bi-arrow-clockwise"></i>
                                                    </a>
                                                </div>
                                                <div>
                                                    <a href="{{ route('clients.permanent-delete', ['id'=>$client->id]) }}" class="btn btn-sm btn-danger">
