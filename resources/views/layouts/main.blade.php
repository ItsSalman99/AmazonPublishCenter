...
<!-- Mirrored from smartinnovates.com/items/iteck/html/home-marketing-startup.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Aug 2022 15:09:58 GMT -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light style-6">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">
                        <img src="assets/frontend/images/newlogo.png" alt="">
                    </a>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="info">
                            <h6 style="text-align: left!important;">Amazon Publishing Center</h6>
                            <h1 style="text-align: left!important;">#1 Amazon Publishing Central Company in USA.</small> </span></h1>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <form style="background-color: #fff; padding: 20px; border-radius: 20px; margin-top: 40px;">
                            ...
                            <div class="my-2">
                                ...
                                style="height: 150px; resize: none" placeholder="Your message"></textarea>
                            </div>
                            <div class="my-2">
