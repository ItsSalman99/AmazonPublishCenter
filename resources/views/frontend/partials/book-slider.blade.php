...
<section class="culture section-padding style-5">
    <div class="section-head text-center style-4 mb-60">
        ...
        <h2 class="mb-20"> Some Of Amazon Publish Central <br>
            <span> Company's Thriving Products </span>
        </h2>
        <p>
            Amazon Publish Central presents a spectrum of services to <br>
            choose from, including ghostwriting, SEO writing, book publishing,
            <br> amazon KDP formatting and video book trailers.
        </p>
    </div>
    <div class="content">
